...
==**Main Thesis Projects:**==

<u>Ch.1</u> - Geographic variation in stoichiometry of a social insect

- Examination of relationship between total C, N, and P for three *Aphaenogaster* ant species in response to geographic variation in climate.

<u>Ch. 2</u> - Warming causes shifts in ant colony demography and nutritional ecology differently across latitude (preliminary title)

* Examination of the direct effect of increases in temperature on ant colony demography, total protein, total lipid, and elemental composition (C, N, 13C, and 15N). 

**Side projects:**

Warming impacts on soil nutrient chemistry across latitude
...
This online notebook will include relevant material from each of my main research projects, including results summaries, preliminary figures, notes from meetings with my adviser Sara and committee members, etc.  
